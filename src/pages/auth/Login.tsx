    ...
    <div className="min-h-screen bg-[#E5E8EB] flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-[#E5E8EB] overflow-hidden">
        ...
        <div className="bg-[#0D1B2A] px-8 py-8 text-center">
          <div className="mb-4">
            <svg className="w-12 h-12 mx-auto text-[#D32F2F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form onSubmit={handleLogin} className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center">
              <input type="checkbox" className="rounded border-[#E5E8EB] text-[#D32F2F] focus:ring-[#D32F2F]" />
              <span className="ml-2 text-[#0D1B2A] opacity-70">Remember me</span>
            </label>
            <a href="/forgot-password" className="text-[#D32F2F] hover:text-[#B71C1C] transition-colors duration-200">
              Forgot password?
            </a>
          </div>
