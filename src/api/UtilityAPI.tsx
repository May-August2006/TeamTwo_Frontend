...
export const utilityApi = {
  ...
  create: (data: UtilityTypeRequest) =>
    API.post<UtilityType>("/api/utility-types", data),

  // Update utility type
  update: (id: number, data: UtilityTypeRequest) =>
    API.put<UtilityType>(`/api/utility-types/${id}`, data),
  ...
  generateUtilityBill: (request: UtilityBillRequest): Promise<InvoiceDTO> =>
    API.post<InvoiceDTO>("/api/utility-billing/generate-bill", request).then(
      (response) => response.data
    ),

  generateUtilityBills: (
    requests: UtilityBillRequest[]
  ): Promise<InvoiceDTO[]> =>
    API.post<InvoiceDTO[]>(
      "/api/utility-billing/generate-bills",
      requests
    ).then((response) => response.data),
