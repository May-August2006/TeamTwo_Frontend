      ...
      <div className="p-5">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500 text-sm mb-3">
            {t('homepage.units.perfectFor')} {getBusinessSuggestion(unitSpace)}
          </p>
        </div>

        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="text-center p-2 bg-gray-50 rounded">
            <div className="text-xs text-gray-500">{t('homepage.units.space')}</div>
            <div className="font-bold text-[#1E40AF]">{unitSpace} {t('homepage.units.sqm')}</div>
          </div>
          <div className="text-center p-2 bg-gray-50 rounded">
            <div className="text-xs text-gray-500">{t('homepage.units.type')}</div>
