...
const TOWNSHIPS_BY_STATE: string[][] = [
  // State 1 - Kachin
  ["AHGAYA","BAMANA","DAHPAYA","HAPANA","HPAKANA","KAMANA","KAMATA","KAPATA","KHAHPANA","KHALAHPHA","LAGANA","MAKANA","MAKATA","MAKHABA","MALANA","MAMANA","MANYANA","MASANA","NAMANA","PANADA","PATAAH","PAWANA","SABANA","SADANA","SALANA","SAPABA","SAPAYA","TANANA","TASALA","WAMANA","YABAYA","YAKANA"],
  
  // State 2 - Kayah
  ["BALAKHA","DAMASA","HPASANA","HPAYASA","LAKANA","MASANA","YATANA","YATHANA"],
  
  // State 3 - Kayin
  ["BAAHNA","BAGALA","BATHASA","HPAPANA","KADANA","KADANA","KADATA","KAKAYA","KAMAMA","KASAKA","LABANA","LATHANA","MAWATA","PAKANA","SAKALA","THATAKA","THATANA","WALAMA","YAYATHA"],
